        ...
        <span style="color:blue">
            <span class="popup" onclick="myFunction(this, '{$identify}')">
                ...
                <span class="popuptext" id="{$identify}">
                    <xsl:apply-templates select="/remiXML/play/closeRead[@REF = $identify]"/>
                </span>
            </span>
        </span>
    </xsl:template>
    ...
    <xsl:template match="/remiXML/original/p/replace">
        ...
        <span style="color:orange">
            <span class="popup" onclick="myFunction(this, '{$identify}')">
                <xsl:apply-templates/>
                <span class="popuptext" id="{$identify}">
                    <xsl:apply-templates select="/remiXML/play/replace[@REF = $identify]"/>
                </span>
            </span>
        </span>
    </xsl:template>
    ...
    <xsl:template match="/remiXML/original/p/expand">
        ...
        <span style="color:pink">
            <span class="popup" onclick="myFunction(this, '{$identify}')">
                <xsl:apply-templates/>
                <span class="popuptext" id="{$identify}">
                    <xsl:apply-templates select="/remiXML/play/expand[@REF = $identify]"/>
                </span>
            </span>
        </span>
    </xsl:template>
    ...
    <xsl:template match="/remiXML/original/p/restory">
        ...
        <span style="color:green">
            <span class="popup" onclick="myFunction(this, '{$identify}')">
                <xsl:apply-templates/>
                <span class="popuptext" id="{$identify}">
                    <xsl:apply-templates select="/remiXML/play/restory[@REF = $identify]"/>
                </span>
            </span>
        </span>
    </xsl:template>
    ...
    <xsl:template match="/remiXML/original/p/question">
        ...
        <span style="color:purple">
            <span class="popup" onclick="myFunction(this, '{$identify}')">
                <xsl:apply-templates/>
                <span class="popuptext" id="{$identify}">
                    <xsl:apply-templates select="/remiXML/play/question[@REF = $identify]"/>
                </span>
            </span>
        </span>
    </xsl:template>
